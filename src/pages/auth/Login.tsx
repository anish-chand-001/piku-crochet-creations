            ...
            >
                ...
                <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-primary/80 to-rose-400 p-8 text-center">
                        <p className="font-body text-sm font-semibold uppercase tracking-[0.3em] text-white/80 mb-1">Welcome back</p>
                        <h1 className="font-display text-3xl font-bold text-white">Sign In</h1>
                        <p className="mt-2 font-body text-sm text-white/70">to your Piku Crochet account</p>
                    </div>
